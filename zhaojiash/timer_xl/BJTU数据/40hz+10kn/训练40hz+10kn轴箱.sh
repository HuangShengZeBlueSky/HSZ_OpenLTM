...
model_id="BJTU40hz+10kn轴箱"  # 微调实验ID（区分原训练）
...
# 2. 数据路径 (Data Paths)
# =========================================================
train_root_path="/home/ubuntu/zhaojia/OpenLTM_data_backup/datasets/BJTU_process_data/40Hz_+10kN_process_data/轴箱/train"
