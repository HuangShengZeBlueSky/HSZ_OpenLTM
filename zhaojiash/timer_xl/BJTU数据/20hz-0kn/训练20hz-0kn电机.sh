...
model_id="BJTU20hz_0kn电机"  # 微调实验ID（区分原训练）
...
# 2. 数据路径 (Data Paths)
# =========================================================
train_root_path="/home/ubuntu/zhaojia/OpenLTM_data_backup/datasets/BJTU_process_data/20Hz_0kN/BJTU_电机_process_data_forall/train"
