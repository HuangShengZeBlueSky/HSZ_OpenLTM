...
model_id="工况1_转速12转每秒_微调"  # 微调实验ID（区分原训练）
model_name="autotimes"          # 模型架构（需与预训练权重匹配）
llm_model="OPT"                  # 使用的LLM模型
# 使用你的BJTU数据加载器
data_name="BJTU"
...
# 2. 数据路径 (Data Paths)
# =========================================================
train_root_path="/raid/hsz/OpenLTM_data_backup/datasets/中车研究院实验台数据集/工况1_转速12转每秒/train/"
