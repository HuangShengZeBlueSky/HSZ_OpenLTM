...
# 2. 数据路径
# =========================================================
test_root_path="/raid/hsz/OpenLTM_data_backup/datasets/BJTU_process_data/40Hz_+10kN_process_data/轴箱/test"
# test_data_path 留空
