...
# 2. 数据路径
# =========================================================
# ⚠️ 修正了你原脚本中 hsz 和 OpenLTM 之间缺少的斜杠
test_root_path="/raid/hsz/OpenLTM_data_backup/datasets/BJTU_process_data/20Hz_0kN/BJTU_轴箱_process_data_forall/test"
# test_data_path 留空
