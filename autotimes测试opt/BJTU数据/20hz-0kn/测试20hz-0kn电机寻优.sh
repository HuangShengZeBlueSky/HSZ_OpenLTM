...
# 2. 数据路径
# =========================================================
test_root_path="/raid/hsz/OpenLTM_data_backup/datasets/BJTU_process_data/20Hz_0kN/BJTU_电机_process_data_forall/test"
# test_data_path 留空
