...
model_id="永济工况1_转速1370转每秒LLAMA"  # 微调实验ID（区分原训练）
...
# 2. 数据路径 (Data Paths)
# =========================================================
train_root_path="/raid/hsz/OpenLTM_data_backup/datasets/永济电机轴承数据集/工况1_转速为1370转每分钟/train/"
